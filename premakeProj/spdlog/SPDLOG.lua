project "LibSpdLog"
	...
	filter "system:not windows"
		postbuildcommands {
			"{MKDIR} %{!wks.location}/Libs/include/spdlog",
			"{COPYFILE} %{!wks.location}/vendor/spdlog/include/*.h %{!wks.location}/Libs/include",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/cfg",
			"{COPYFILE} %{!wks.location}/vendor/spdlog/include/cfg/*.h %{!wks.location}/Libs/include/cfg",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/details",
			"{COPYFILE} %{!wks.location}/vendor/spdlog/include/details/*.h %{!wks.location}/Libs/include/details",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/fmt",
			"{COPYFILE} %{!wks.location}/vendor/spdlog/include/fmt/*.h %{!wks.location}/Libs/include/fmt",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/fmt/bundled",
			"{COPYFILE} %{!wks.location}/vendor/spdlog/include/fmt/bundled/*.h %{!wks.location}/Libs/include/fmt/bundled",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/sinks",
			"{COPYFILE} %{!wks.location}/vendor/spdlog/include/sinks/*.h %{!wks.location}/Libs/include/sinks",
		}