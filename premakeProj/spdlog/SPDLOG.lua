project "LibSpdLog"
	...
	filter "system:not windows"
		postbuildcommands {
			"{MKDIR} %{!wks.location}/Libs/include/spdlog",
			"{COPYFILE} -n %{!wks.location}/vendor/spdlog/include/spdlog/*.h %{!wks.location}/Libs/include/spdlog/ 2>&1 || true",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/cfg",
			"{COPYFILE} -n %{!wks.location}/vendor/spdlog/include/spdlog/cfg/*.h %{!wks.location}/Libs/include/spdlog/cfg/ 2>&1 || true",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/details",
			"{COPYFILE} -n %{!wks.location}/vendor/spdlog/include/spdlog/details/*.h %{!wks.location}/Libs/include/spdlog/details/ 2>&1 || true",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/fmt",
			"{COPYFILE} -n %{!wks.location}/vendor/spdlog/include/spdlog/fmt/*.h %{!wks.location}/Libs/include/spdlog/fmt/ 2>&1 || true",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/fmt/bundled",
			"{COPYFILE} -n %{!wks.location}/vendor/spdlog/include/spdlog/fmt/bundled/*.h %{!wks.location}/Libs/include/spdlog/fmt/bundled/ 2>&1 || true",
			"{MKDIR} %{!wks.location}/Libs/include/spdlog/sinks",
			"{COPYFILE} -n %{!wks.location}/vendor/spdlog/include/spdlog/sinks/*.h %{!wks.location}/Libs/include/spdlog/sinks/ 2>&1 || true",
		}