project "LibZeroMQ"
	...
	filter "system:not windows"
		postbuildcommands {
			"{COPYFILE} -n %{!wks.location}/vendor/libzmq/include/*.h %{!wks.location}/Libs/include",
			"{COPYFILE} -n %{!wks.location}/premakeProj/libzmq/platform.hpp %{!wks.location}/Libs/include"
		}
